 ...
 */
package com.ghart.dartweather.data;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        // Move the cursor to verify that there is only one record
        assertFalse("Error: More than one record in the database", cursor.moveToNext());
